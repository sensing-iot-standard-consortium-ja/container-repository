            ...
            <form class="settings">
                <div class="settings-row">
                    <fieldset class="setting endian">
                        ...
                        <div class="group"><input id="little-endian" type="checkbox" v-model="settings.le" /><label id="little-endian-label" for="little-endian">Show little-endian</label></div>
                        <div class="group"><input id="big-endian" type="checkbox" v-model="settings.be" /><label id="big-endian-label" for="little-endian">Show big-endian</label></div>
                    </fieldset>
